"""Build Table 1 — Headline performance across 4 cohorts × 3 methods.
...
COHORT_LABELS = {
    "datasetA":      "Cohort D · Development (n=1,010)",
    "datasetB_v6":   "Cohort V1 · External validation 1 (n=173)",
    "xiangya_720":   "Cohort V2 · External validation 2 (n=630)",
    "xiangya_16218": "Cohort V3 · External validation 3 (n=14,748)",
}
...
def main() -> None:
    ...
    doc = [
        ...
        "## What's in it\n",
        "- One block per cohort (4 blocks total).\n",
        ...
        "- NPV is at least 0.928 across all four current cohorts.\n\n",
        "## Sources\n",
