...
(1,010 / 173 / 15,109 in the final D/V1/V2 analysis structure).
...
Cohort sources:
    cohort_D  — public release Cohort D CP2E table
    cohort_V1 — restricted_inputs/cohort_V1/cp_inputs/dataset_CP2E*.csv
    cohort_V2 — restricted_inputs/cohort_V2/cp_inputs/dataset_CP2E*.csv
"""
...
CP2E_PATHS = {
    "cohort_D": ROOT / "data" / "raw_data" / "cohort_D" / "cohort_D_CP2E_demo_history_exam_lab_echo.csv",
    "cohort_V1": RESTRICTED_INPUT_ROOT / "cohort_V1" / "cp_inputs" / "dataset_CP2E_demo_history_exam_lab_echo.csv",
    "cohort_V2": RESTRICTED_INPUT_ROOT / "cohort_V2" / "cp_inputs" / "dataset_CP2E_demo_history_exam_lab_echo.csv",
}

ID_FILTERS = {
    "cohort_D": ROOT / "data" / "derived" / "cohort_D" / "RETAINED_sample_ids.csv",
    "cohort_V1": RESTRICTED_INPUT_ROOT / "cohort_V1" / "retained_ids.csv",
    "cohort_V2": RESTRICTED_INPUT_ROOT / "cohort_V2" / "retained_ids.csv",
}
